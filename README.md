...
2. **Задать ключ доступа к бирже**
   В .env файле создать переменную EXCHANGERATE_API_KEY которая содержит в себе персональный API-ключ. Ключ можно бесплатно получить, пройдя регистрацию на сайте https://www.exchangerate-api.com/.
